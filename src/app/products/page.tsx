...
export const metadata = createMetadata({
  title: "Products",
  description:
    "See the current Arbitrary Systems product portfolio, including The Registry, PranaLogic, Group Pours, and I'm open 2.",
  path: "/products",
});
