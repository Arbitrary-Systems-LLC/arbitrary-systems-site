...
const logos = [
  ...
  },
  {
    name: "Group Draws",
    kind: "Product mark",
    src: "/products/group-draws-icon.png",
    downloadName: "group-draws-icon.png",
    alt: "Group Draws icon",
    width: 512,
    height: 512,
    tone: "mark" as const,
  },
  {
    name: "Group Draws",
    kind: "Product wordmark",
    src: "/products/group-draws-wordmark.png",
    downloadName: "group-draws-wordmark.png",
    alt: "Group Draws wordmark",
    width: 720,
    height: 350,
    tone: "wordmark" as const,
  },
