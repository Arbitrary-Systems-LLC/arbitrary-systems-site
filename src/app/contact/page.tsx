        ...
        <div className="container page-stack">
          <div className="split-grid">
            <div className="panel">
              ...
              <p>
                If your note relates to The Registry, PranaLogic, Group Pours, or I&apos;m open 2, mention the product in the subject line so the conversation starts in the right place.
              </p>
            </div>
            <div className="panel">
